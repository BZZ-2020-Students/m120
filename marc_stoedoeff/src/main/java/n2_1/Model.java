...
/**
 * Das Daten-n2_1.Model representiert eine Vielzahl von Strings (z.B. Hobbies)
 * Die Datenwerte werden in einem Vector gehalten.
 * 
 * F?r die Kommunikation mit der n2_1.View werden die notwendigen Methoden aus
...
public class Model extends DefaultListModel<String>{
   ...
   * Danach muss die n2_1.View-Komponente ?ber die ?nderung der Daten
