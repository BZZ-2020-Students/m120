...
public class JavaPhoneGUI extends JFrame {
    ...
    // ...
    JButton hookupkey = new JButton("Hook off");
    ...
    JavaPhoneGUI() {
        ...
        for (int i = 0; i < keys.length; i++) {
            ...
            keys[i].addActionListener(e -> {
                display.setText(display.getText() + keys[finalI].getText());
            });
        ...
        hookupkey.addActionListener(e -> {
                    if (hookupkey.getText().equals("Hook on")) {
                        state.setText("ready");
                        hookupkey.setText("Hook off");
                        display.setText("");


                    } else {
                        hookupkey.setText("Hook on");
